...
![Central Sulcus (Rolandic Fissure or Fissure of Rolando)](https://upload.wikimedia.org/wikipedia/commons/8/88/Central_sulcus_diagram.png)
...
knitr::include_graphics("../include/img/brainstem-white-matter-schematic.jpg")
```
...
knitr::include_graphics("../include/img/projection-fiber-schematic.jpg")
```
...
```{r}
knitr::include_graphics("../include/img/cortical-white-matter-schematic.jpg")
```
...
knitr::include_graphics("../include/img/cortical-white-matter.jpg")
```
