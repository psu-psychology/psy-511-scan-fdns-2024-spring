...
{{< video https://youtu.be/8UhAanlThUE?si=cCjZCpwuXqZGQafB  >}}
...
%%| fig-cap: Highlighting the output stream
flowchart TD
N{Nervous System} ==>|Motor neurons|B(Muscle fibers)
N ==>|Efference Copy|N
B ==>|Ia spindle afferents|N
```
