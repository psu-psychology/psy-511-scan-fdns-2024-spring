...
```{r, out.width = "800px"}
knitr::include_graphics("../include/img/psych-harder-1.jpg")
```

---

```{r, out.width = "800px"}
knitr::include_graphics("../include/img/psych-harder-2.jpg")
```
...
knitr::include_graphics("../include/img/nested-causality-labels.png")
```
...
<div class="centered">
```{r, out.height="500px"}
knitr::include_graphics("../include/img/calabrese-2018.jpg")
```
...
## And *vice versa*? [@Cepelewicz2021-rg]
...
- Neuroanatomy lab
  - Read/study
    ...
    - Neuroanatomy [outline](resources/neuroanatomy-outline.qmd)
